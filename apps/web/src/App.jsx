...
const QUERIES = {
  ...
  retrievalMetrics: `query($t:ID!){getRetrievalMetrics(tenant_id:$t){count avg_seconds p95_seconds fastest_seconds last_retrieved}}`,
  reminders: `query($t:ID!){getReminders(tenant_id:$t){reminder_id kind message due_date status}}`,
